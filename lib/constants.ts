...
export const CATALOG_ITEMS: (CatalogItem & { points: number; aliases?: string[] })[] = [
  ...
  { id: 'pos-transversal-gestao-estrategica', label: 'Gestão Estratégica', group: 'postMBA', classification: 'transversal', points: 40, aliases: ['Gestão Estratégica', 'MBA em Gestão Estratégica', 'Gestão Estratégica Empresarial', 'Gestão de Estratégia Empresarial', 'Estratégia Empresarial', 'Estratégia Organizacional'] },
  ...
  { id: 'proj-urc-mapeamento-e-melhoria-de-controles-internos', label: 'Mapeamento e melhoria de controles internos', group: 'project', classification: 'area-specific', points: 20, area: 'URC', aliases: ['controles internos', 'mapeamento de controles', 'melhoria de controles', 'gestão de credenciados', 'MOP', 'manual operacional de processos'] },
  // UAC
