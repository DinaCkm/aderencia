...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  p.projectAreaMap = {
    'Jornada do cliente e padronização de atendimento': 'URC',       // catálogo: URC ✅
    'Execução estratégica regional do portfólio': 'REGIONAIS',       // catálogo: REGIONAIS ✅
    'Articulação regional e parcerias territoriais': 'REGIONAIS',    // catálogo: REGIONAIS ✅
  };
